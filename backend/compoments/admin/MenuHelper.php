...
namespace backend\compoments\admin;
...
class MenuHelper
{
    ...
    public static function getMenuData() {
        return [
            ["id"=>"1","value"=>"System Management","route"=>null,"parent_namexxxxx"=>null],
            ["id"=>"2","value"=>"User","route"=>"\/user\/index","parent_namexxxxxx"=>"System Management"]
        ];
    }
}
