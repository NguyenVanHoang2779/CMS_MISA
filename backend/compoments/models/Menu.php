...
namespace backend\compoments\models;
...
class Menu extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            'id' => Yii::t('rbac-custom', 'ID'),
            'name' => Yii::t('rbac-custom', 'Name'),
            'parent' => Yii::t('rbac-custom', 'Parent'),
            'parent_name' => Yii::t('rbac-custom', 'Parent Name'),
            'route' => Yii::t('rbac-custom', 'Route'),
            'order' => Yii::t('rbac-custom', 'Order'),
            'data' => Yii::t('rbac-custom', 'Data'),
        ];
    }
